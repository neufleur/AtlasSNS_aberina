...
<div class="profile-update">
        ...
        <label class="profile-add"><img src="{{ asset('storage/images/' . $auth->images) }}" >username<input type="text" class="form-name" name="username" placeholder="" value="{{ $auth->username }}"></label>
        ...
        <label class="profile-add">icon image<input type="file" class="images" name="images"></label>
